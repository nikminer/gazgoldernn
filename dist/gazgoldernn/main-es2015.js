...
class AppComponent {
    ...
    submit() {
        ...
        return this.http.post('https://www.gazgoldernn.ru/send_messages.php', body, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded') })
            .subscribe(status => {
            if (status == 1) {
